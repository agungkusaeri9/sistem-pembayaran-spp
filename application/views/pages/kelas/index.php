                    ...
                    <table class="table dtable table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $jrs->nama_kelas ?></td>
								<td><?= $jrs->jurusan ?></td>
                                <td>
									<a href="<?= base_url('kelas/edit/') . $jrs->id_kelas ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Edit</a>
									<form action="" method="post" id="formDelete" class="d-inline">
										<button class="btn btn-sm btn-danger btnDelete" data-id="<?= $jrs->id_kelas ?>"><i class="fas fa-trash"></i> Hapus</button>
									</form>
								</td>
                            </tr>
                            <?php endforeach; ?>
	...
	$(function(){
		...
		$('body').on('click','.btnDelete', function(e){
			...
			if (result.isConfirmed) {
                $('#formDelete').attr('action','<?= base_url('kelas/delete/') ?>' + id)
				$('#formDelete').submit();
				}
			})
		})
